...
class Defect extends CI_Controller {
    ...
    {
      if(CheckMenuRole('defect')){
        redirect("errors");
      }
			$data['title'] = 'Master Defect';
			$data['main'] = 'defect/index';
			$data['js'] = 'script/defect';
			$data['modal'] = 'modal/defect';
    ...
    public function dataTable()
    {
        ...
        $pengguna = $this->db->get('tb_defect');
        $data = array();
    ...
    public function edit(){
        ...
        $arr_par = array('id' => $id);
        $data = $this->admin->getmaster('tb_defect',$arr_par);
  ...
  {       
      ...
      if($this->input->post('id_defect') != "") {

          $this->db->set($data);
          $this->db->where('id_ruangan', $this->input->post('id_defect'));
          $result  =  $this->db->update('tb_defect');  
          ...
          $result  = $this->db->insert('tb_defect', $data);
  ...
  public function delete()
  {
      $response = [];
      $response['error'] = TRUE; 
      if($this->admin->deleteTable("id",$this->input->get('id'), 'tb_defect' )){
        $response['error'] = FALSE;
      } 
