...
class Users extends CI_Controller
{
    ...
    public function Save()
    {
        ...
        if ($this->input->post('id') != "") {
            ...
            $group_user = $this->admin->get_array(
                'tb_group_user',
                array(
    ...
    public function delete()
    {
        ...
        $response['error'] = TRUE;
        try {
            $user = $this->admin->get_array('tb_user', array('id_user' => $this->input->get('id', TRUE)));
            $exist = $this->admin->get_array('linen_kotor', array('PIC' => $user['nama_user']));
            if (!empty($exist)) {
