...
class Barang extends CI_Controller
{
  ...
  public function delete()
  {
    ...
    try {
      $exist = $this->admin->get_array('linen_kotor_detail', array('epc' => $this->input->get('id')));
      if (!empty($exist)) {
        throw new Exception("Data telah digunakan pada transaksi linen");
      }

      $exist_bersih = $this->admin->get_array('linen_bersih_detail', array('epc' => $this->input->get('id')));
      if (!empty($exist_bersih)) {
        throw new Exception("Data telah digunakan pada transaksi linen");
      }

      $exist_keluar = $this->admin->get_array('linen_keluar_detail', array('epc' => $this->input->get('id')));
      if (!empty($exist_keluar)) {
        throw new Exception("Data telah digunakan pada transaksi linen");
      }
