<div class="col-lg-6 col-md-6 ml-auto mr-auto">
  <div class="card card-lock text-center">
    ...
    <form method="POST" action="<?php echo base_url() ?>index.php/login/update">
    <div class="card-body ">
      <p class="card-title" style="margin-top: 0px;">Password anda akan kadaluarsa dalam  hari lagi, silahkan perbaharui password anda segera</p>
      ...
      <div class="form-group">
        <input type="password" name="last_password" class="form-control" placeholder="Masukkan Password Terakhir">
    ...
    <div class="card-footer ">
      ...
      <a href="<?php echo $this->input->get('base_url') ?>" class="btn btn-round btn-default">Kembali Ke Aplikasi <?php echo $this->input->get('apps') ?></a>
