  ...
  <div class="card-header back-green" style="color:#fff">
    <div class="row">
        <div class="col-xl-10">
            ...
            <span>Halaman ini untuk merequest linen yang baru/belum terdaftar</span>
        </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <select name="jenis" id="jenis" class="form-control">
            <option value="Medis" <?= empty($data) ? "" : ($data['jenis'] == "Medis" ? "selected" : "") ?>>Medis</option>
            <option value="Non Medis" <?= empty($data) ? "" : ($data['jenis'] == "Non Medis" ? "selected" : "") ?>>Non Medis</option>
          </select>
        </div>
      </div>
      <div class="form-group row">
