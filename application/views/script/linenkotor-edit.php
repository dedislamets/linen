<script type="text/javascript">
	...
	$('#btnCetak').on('click', function(event) {
		var id_kotor_encrypted = btoa($("#id_kotor").val());
		window.open("<?= base_url(); ?>cetak?p=kotor&id=" + id_kotor_encrypted, '_blank');
	})
	...
	function cancel(val) {
		...
		if (id != "") {
			...
			if (r == true) {
				$.get('<?= base_url() ?>linenkotor/delete', {
					id: id,
