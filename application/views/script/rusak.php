<script type="text/javascript">
	    ...
	    $('#ViewTableDetail').DataTable({
			...
			"columnDefs": [
	            ...
	            "render": function ( data, type, row, meta ) {
	                var text = '<a href="listrusak/edit/'+ data +'" style="font-weight:500;">'+ data +'</a>';
	              	return text;
	            	}
	          	},
			]
	...
	function hapus(val) {
		...
		if (r == true) {
			...
			$.get('listrusak/deletelist', { id: $(val).data('id') }, function(data){ 
				window.location.reload();
			})
